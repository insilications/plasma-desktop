...
Requires: plasma-desktop-libexec = %{version}-%{release}
...
%package libexec
Summary: libexec components for the plasma-desktop package.
Group: Default

%description libexec
libexec components for the plasma-desktop package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643429581
mkdir -p clr-build
pushd clr-build
